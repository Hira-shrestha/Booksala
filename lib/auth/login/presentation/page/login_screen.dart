...
import 'package:library_store/auth/login/presentation/cubit/newlogin_cubit.dart';
import 'package:library_store/auth/login/presentation/cubit/newlogin_state.dart';
import 'package:library_store/auth/login/presentation/page/login_form.dart';
...
class MyLoginScreen extends StatelessWidget {
  ...
  void gotoListing(BuildContext context) {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => const TabBarController()));
  }
