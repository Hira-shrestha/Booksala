...
const RemoveBook = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'RemoveBook'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'removeBookId')),
    ...
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'removeBookId')),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [RemoveBook]);
