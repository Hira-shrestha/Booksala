    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Container(
          height: 50,
          color: Colors.white,
          child: FullWidthButton(name: 'Log out', callbackAction: () {
            print('Log out');
...
class FullWidthButton extends StatelessWidget {
  FullWidthButton({required this.name, required this.callbackAction, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.all(4.0), // Optional: Adds some margin around the button
