...
const GetBookByAuthor = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'GetBookByAuthor'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'getMyBookInput')),
    ...
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'getMyBookInput')),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [GetBookByAuthor]);
